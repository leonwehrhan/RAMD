...
sed "s/XX/${i}/"  ../MDP/md.mdp > md${SLURM_ARRAY_TASK_ID}.mdp;

gmx grompp -f ../MDP/md${SLURM_ARRAY_TASK_ID}.mdp -c ../umb0_start.gro -p ../topol.top -n ../index.ndx -o md${SLURM_ARRAY_TASK_ID}.tpr;
